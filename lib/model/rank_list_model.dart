...
class RankListModel {
  ...
  factory RankListModel.fromJson(jsonRes) {
...
class TrackIds {
  ...
  factory TrackIds.fromJson(jsonRes) => jsonRes == null
      ...
      : TrackIds(
          ...
          lr: convertValueByType(jsonRes['lr'], int, stack: "TrackIds-lr"),
        );
  Map<String, dynamic> toJson() => {
        'id': id,
        'v': v,
